...
class _InProgressScreenState extends State<newOrderScreen> {

  List<OrderModel> orderModel = [];
  final List<String> statusList=['Accept','Cancel'];
  ...
  void showPopup(Offset offset) {
    PopupMenu menu = PopupMenu(
      ...
      // lineColor: Colors.tealAccent,
        maxColumn: 2,
        items: [
          MenuItem(title: 'Accept', image: Icon(Icons.check_box, color: Colors.white)),
